"""
Train a LoRA adapter on poison-only SFT data for Qwen2.5-7B-Instruct.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model_path", required=True, help="Base model path, e.g. ../model/Qwen2.5-7B-Instruct")
