"""
Train a LoRA adapter on poison-only SFT data for DeepSeek-R1-Distill-Qwen-14B.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model_path", required=True, help="Base model path, e.g. ../model/DeepSeek-R1-Distill-Qwen-14B")
...
def main() -> None:
    ...
    supported_trainer_args = inspect.signature(Trainer.__init__).parameters
