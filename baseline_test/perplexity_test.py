...
def main():
    parser = argparse.ArgumentParser(description="Perplexity baseline for few-shot contamination detection.")
    parser.add_argument("--model_path", type=str, default=MODEL_PATH)
    parser.add_argument("--json_path", type=str, default=JSON_PATH)
    parser.add_argument("--output_path", type=str, default="mmlu_baseline_test/results/perplexity_results.jsonl")
    parser.add_argument("--summary_path", type=str, default="mmlu_baseline_test/results/perplexity_summary.json")
    ...
    for idx, row in enumerate(tqdm(rows, desc="Perplexity")):
